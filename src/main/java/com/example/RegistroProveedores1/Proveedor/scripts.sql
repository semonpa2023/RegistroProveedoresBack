...
CREATE TABLE `departamentos` (
                                 ...
                                 `pais_id` int(3) unsigned NOT NULL,
                                 PRIMARY KEY (`id_departamento`),
                                 KEY `pais_id` (`pais_id`),
                                 CONSTRAINT `fk_departamento_pais` FOREIGN KEY (`pais_id`) REFERENCES `paises`(`id_pais`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;



INSERT INTO `departamentos` (`id_departamento`, `departamento`, `pais_id`)
VALUES
    (5, 'ANTIOQUIA', 1),
    (8, 'ATLÁNTICO', 1),
    (11, 'BOGOTÁ, D.C.', 1),
...
INSERT INTO TipoPersona (idTipoPersona, tipoPersona) VALUES (1, 'Persona natural');
INSERT INTO TipoPersona (idTipoPersona, tipoPersona) VALUES (2, 'Persona jurídica');


CREATE TABLE nitOrut (
                         idRutNit INT PRIMARY KEY,
                         nitOrut VARCHAR(50)
);

INSERT INTO nitOrut (idRutNit, nitOrut) VALUES (1, 'NIT');
INSERT INTO nitOrut (idRutNit, nitOrut) VALUES (2, 'RUT');
